...
# GRE-over-IPSec: MI-3650 &mdash; Device Configuration
...
ip address 10.100.30.1 255.255.254.0
exit

interface Vlan40
no shutdown
ip address 10.100.40.1 255.255.254.0
exit

interface Vlan50
no shutdown
ip address 10.100.50.1 255.255.252.0
exit
...
interface range GigabitEthernet1/0/6 - 23
switchport mode access
...
dns-server 10.100.30.100
exit
ip dhcp excluded-address 10.100.20.1 10.100.20.100

! VLAN30 DHCP pool
ip dhcp pool VLAN30_POOL
network 10.100.30.0 255.255.254.0
default-router 10.100.30.1
dns-server 10.100.30.100
exit
ip dhcp excluded-address 10.100.30.1 10.100.30.100

! VLAN40 DHCP pool
ip dhcp pool VLAN40_POOL
network 10.100.40.0 255.255.254.0
default-router 10.100.40.1
dns-server 10.100.30.100
exit
ip dhcp excluded-address 10.100.40.1 10.100.40.100

! VLAN50 DHCP pool
ip dhcp pool VLAN50_POOL
network 10.100.50.0 255.255.252.0
default-router 10.100.50.1
dns-server 10.100.30.100
exit
ip dhcp excluded-address 10.100.50.1 10.100.50.100
